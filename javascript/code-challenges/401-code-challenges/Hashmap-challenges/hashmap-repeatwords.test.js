...
describe('Repeated Words in String via Hash Table', () => {

  test('Checks for first repeated word in a string', () => {
    let string = 'Once upon a time, there was a brave princess who...';
    expect(repeatedWords(string)).toEqual('a');
  });
  ...
  test('Checks for first repeated word in a string', () => {
    ...
    expect(repeatedWords(string)).toEqual('it');
  });
  ...
  test('Checks for first repeated word in a string', () => {
    ...
    expect(repeatedWords(string)).toEqual('the');
  });
